...
export class Migration1777002977371 implements MigrationInterface {
    name = 'Migration1777002977371'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "calendar" ("id" uuid NOT NULL, "clientId" uuid NOT NULL, "mealPlanId" uuid, CONSTRAINT "REL_d68162e2e82cffacb299b215d0" UNIQUE ("mealPlanId"), CONSTRAINT "PK_2492fb846a48ea16d53864e3267" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "meal_plan" ("id" uuid NOT NULL, "startDate" date NOT NULL, "endDate" date NOT NULL, "durationDays" integer NOT NULL, "clientId" uuid, CONSTRAINT "PK_b526e5597b340a2c47380a5033d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dayli_diet_recipes" ("dayliDietId" uuid NOT NULL, "recipeId" uuid NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_04464d35bb69d719e741eadb8e4" PRIMARY KEY ("dayliDietId", "recipeId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "calendar" ADD CONSTRAINT "FK_d68162e2e82cffacb299b215d09" FOREIGN KEY ("mealPlanId") REFERENCES "meal_plan"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "dayli_diet_recipes" ADD CONSTRAINT "FK_f250249a5a5a9093862879c0c16" FOREIGN KEY ("dayliDietId") REFERENCES "dayli_diet"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "calendar" DROP CONSTRAINT "FK_d68162e2e82cffacb299b215d09"`);
